    ...
    await (async () => {
          ...
          //console.log("Suggested base fee history:", baseFeeHistory);
            ...
            if(networkCongestion > 0.5){
                ...
                if((currentBaseFee >= (0.05*baseFeePercentile + baseFeePercentile) && currentBaseFee <= (baseFeePercentile - 0.05*baseFeePercentile)) || (currentBaseFee <= busyThreshold) || (currentBaseFee >= (0.05*median + median) && currentBaseFee <= (median - 0.05*median))){
